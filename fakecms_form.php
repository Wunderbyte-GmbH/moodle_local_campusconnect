...
class fakecms_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'dirrootid', 'Root directory id', ['size' => 10]);
        $mform->setType('dirrootid', PARAM_TEXT);
        $mform->addElement('text', 'dirid', 'Directory id', ['size' => 10]);
        $mform->setType('dirid', PARAM_TEXT);
        $mform->addElement('text', 'dirtitle', 'Directory title');
        $mform->setType('dirtitle', PARAM_TEXT);
        $mform->addElement('text', 'dirparentid', 'Parent directory id', ['size' => 10]);
        $mform->setType('dirparentid', PARAM_TEXT);
        $mform->addElement('text', 'dirorder', 'Directory order (within parent)', ['size' => 10]);
        ...
        $mform->addElement('text', 'crsid', 'Course id', ['size' => 10]);
        $mform->setType('crsid', PARAM_TEXT);
        $mform->addElement('text', 'crsterm', 'Term', ['size' => 10]);
        ...
        */
        ...
        for ($i = 1; $i <= 3; $i++) {
            $grp = [
                $mform->createElement('text', "crsallparent[$i]", '', ['size' => 10]),
                $mform->createElement('text', "crsallorder[$i]", '', ['size' => 10]),
            ];
        ...
        for ($i = 1; $i <= 3; $i++) {
            ...
            $mform->addElement('text', "crspid[$i]", "PGroup$i id", ['size' => 10]);
            $mform->setType("crspid[$i]", PARAM_TEXT);
            $mform->setAdvanced("crspid[$i]");
            $mform->addElement('text', "crspcomment[$i]", "PGroup$i comment", ['size' => 40]);
        ...
        $mform->addElement('text', 'mbrcourseid', 'Course id', ['size' => 10]);
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            for ($j = 1; $j <= 3; $j++) {
                $mform->addElement('text', "mbrpgid[$i][$j]", "PGroup $i.$j ID", ['size' => 10]);
